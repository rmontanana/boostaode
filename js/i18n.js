...
const i18n = (() => {
    const translations = {
        en: {
            ...
            'charts.name.compressionHist': 'Compression Histogram',
            'charts.name.compressionFeatures': 'Compression vs Features',
            ...
            'charts.desc.scatterPareto': 'Pareto front: accuracy (X axis) vs model simplicity (Y axis). AODE always has simplicity 0 (uses all SPODEs). BoostAODE can achieve higher simplicity by selecting fewer SPODEs.',
            ...
            'charts.axis.compressionRatio': 'Compression Ratio (n_spodes / n_features)',
            ...
            'charts.axis.compressionRatioShort': 'Compression ratio',
        ...
        es: {
            ...
            'charts.name.compressionHist': 'Histograma Compresi\u00f3n',
            'charts.name.compressionFeatures': 'Compresi\u00f3n vs Features',
            ...
            'charts.desc.scatterPareto': 'Frente de Pareto: accuracy (eje X) frente a simplicidad del modelo (eje Y). AODE siempre tiene simplicidad 0 (usa todos los SPODEs). BoostAODE puede alcanzar mayor simplicidad al seleccionar menos SPODEs.',
            ...
            'charts.axis.compressionRatio': 'Ratio de Compresi\u00f3n (n_spodes / n_features)',
            ...
            'charts.axis.compressionRatioShort': 'Ratio de compresi\u00f3n',
